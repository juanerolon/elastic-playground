...
#Inline json data: example 2
#The right hand side of assingment statement below is the content of an actual json file

data2 = [{
 		"user_id": 1,
 		"timestamp": "2016-03-22_11-31-20",
 		"tweet": "It's #dinner-time, John. The Matrix is on!"
 	},

 	{
 		"user_id": 2,
 		"timestamp": "2016-03-20_12-30-25",
 		"tweet": "The @force is strong with you, Luke."
 	}
 ]
...
df1 = pd.read_json(json_string1, orient='records')
df2 = pd.read_json(json_string2, orient='records')
df3 = pd.read_json(json_string3, orient='records')

print("")

print("Dataframe for json data1\n")
print(df1)

print("")

print("Dataframe for json data2\n")
print(df2)
